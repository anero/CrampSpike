require './application'
CrampSpike::Application.initialize!

# Development middlewares
if CrampSpike::Application.env == 'development'
  ...
  use Rack::Static, :urls => ["/javascripts"], :root => CrampSpike::Application.root(:public)
end
...
#
run CrampSpike::Application.routes
